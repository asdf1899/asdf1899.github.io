  ...
  <FullpageSection>
    <section className="flex h-screen flex-wrap">
      ...
      <div className="flex flex-wrap w-full">
        <div className="flex w-full sm:w-full md:w-1/3 lg:w-1/3 xl:w-1/3 justify-center" style={{textAlign: 'center'}}>
          <img src={logoBelka} className="text-center h-24 md:h-32 lg:h-32 xl:h-32" />
        </div>
        <div className="flex w-full pt-3 sm:w-full md:w-1/3 lg:w-1/3 xl:w-1/3 justify-center">
          <img src={logoFbk} className="text-center w-full h-24 md:h-32 lg:h-32 xl:h-32"  />
        </div>
        <div className="flex w-full pt-3 sm:w-full md:w-1/3 lg:w-1/3 xl:w-1/3 justify-center">
          <img src={logoIes} className="text-center w-full h-16 md:h-24 lg:h-24 xl:h-24" />
        </div>
      </div>
    </section>
  </FullpageSection>
